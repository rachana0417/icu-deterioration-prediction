...
def generate_pdf():
    ...
    explanation="""
The AI ICU Guardian system uses deep learning models to evaluate
physiological trends from real-time ICU monitoring data.

Temporal patterns in heart rate, oxygen saturation and respiratory
rate are analyzed to detect early signals of clinical deterioration.

The system provides risk predictions across multiple time horizons
to assist clinicians in proactive intervention.
"""
